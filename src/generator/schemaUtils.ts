...
export type SupportedScalarType = "string" | "int32" | "uint32" | "sint32" | "int64" | "uint64" | "sint64" | "bool" | "bytes" | "float";
...
const SUPPORTED_SCALAR_TYPES: SupportedScalarType[] = ["string", "int32", "uint32", "sint32", "int64", "uint64", "sint64", "bool", "bytes", "float"];
